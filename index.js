...
@media (max-width: 900px) {
    ...
    function ensureMenuItem() {
        ...
        item.innerHTML = `
            <div class="extensionsMenuExtensionButton">${state.iconHtml}</div>
    ...
    function renderPlaceholder() {
        ...
        body.innerHTML = `
            <div class="stus-empty">
                ...
                <div class="stus-note">下一步请在你的业务脚本里调用 <code>window.STUserScriptShell.mount(renderFn)</code>，把真正的插件 UI 挂进来。</div>
            </div>
        `;
    }
